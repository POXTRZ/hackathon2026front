  ...
  return (
    ...
    >
      ...
      <div className="lg:col-span-3 grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10">
        ...
        {/* Cam 1 - UCI */}
        <motion.div 
          className="bg-black rounded-[2.5rem] overflow-hidden aspect-video relative border border-slate-700/80 shadow-2xl group hover:border-blue-500/50 transition-colors"
        >
          <div className="absolute inset-0 bg-[#0f172a] flex items-center justify-center overflow-hidden">
            {/* Grid Pattern */}
            <div className="absolute inset-0 opacity-[0.15]" style={{ backgroundImage: 'radial-gradient(circle, #60a5fa 1px, transparent 1px)', backgroundSize: '30px 30px' }}></div>
            ...
            <Camera className="text-slate-800 drop-shadow-[0_0_15px_rgba(30,41,59,1)]" size={64} />
          ...
          <div className="absolute top-6 left-6 bg-[#0a0f1d]/80 backdrop-blur-xl px-4 py-2 rounded-xl flex items-center gap-3 border border-white/10 ring-1 ring-black/50 shadow-xl">
            ...
            <span className="text-[10px] font-extrabold text-slate-200 uppercase tracking-[0.2em]">UCI 04 <span className="text-slate-500 font-bold ml-2">Contactless</span></span>
          </div>
        ...
        {/* Cam 2 - Quirófano */}
        <motion.div 
          className="bg-black rounded-[2.5rem] overflow-hidden aspect-video relative border border-slate-700/80 shadow-2xl group hover:border-amber-500/50 transition-colors"
        >
          <div className="absolute inset-0 bg-[#0f172a] flex items-center justify-center overflow-hidden">
            ...
            >
              <span className="bg-blue-600/90 backdrop-blur-md text-white text-[8px] font-black px-1.5 py-0.5 rounded shadow-lg tracking-widest">GASA</span>
            </motion.div>
            <motion.div 
            ...
            >
              <span className="bg-amber-600/90 backdrop-blur-md text-white text-[8px] font-black px-1.5 py-0.5 rounded shadow-lg tracking-widest">BISTURÍ</span>
            </motion.div>
          </div>
          
          <div className="absolute top-6 left-6 bg-[#0a0f1d]/80 backdrop-blur-xl px-4 py-2 rounded-xl flex items-center gap-3 border border-white/10 ring-1 ring-black/50 shadow-xl">
            <div className="w-2 h-2 bg-red-500 rounded-full animate-pulse shadow-[0_0_10px_rgba(239,68,68,1)]"></div>
            <span className="text-[10px] font-extrabold text-slate-200 uppercase tracking-[0.2em]">Quirófano 02 <span className="text-slate-500 font-bold ml-2">YOLOv12</span></span>
          </div>
          ...
          <div className="absolute bottom-6 right-6 bg-[#0f172a]/90 backdrop-blur-xl p-4 rounded-2xl border border-slate-700/80 shadow-[0_10px_40px_rgba(0,0,0,0.5)] flex flex-col items-end">
            <p className="text-[9px] text-slate-400 font-black uppercase tracking-[0.2em] mb-1 flex items-center gap-2">
              Conteo AI <div className="w-1.5 h-1.5 bg-emerald-500 rounded-full shadow-[0_0_5px_rgba(16,185,129,1)]"></div>
            </p>
            <p className="text-xl text-white font-black tracking-tight">14 <span className="text-slate-500">/ 14</span> <span className="text-emerald-400 font-extrabold text-sm uppercase tracking-widest ml-2">OK</span></p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="mb-6 relative z-10">
            <div className="w-16 h-16 bg-emerald-500/10 rounded-[1.5rem] flex items-center justify-center mx-auto mb-4 border border-emerald-500/20 shadow-[inset_0_0_20px_rgba(16,185,129,0.1)] group-hover:shadow-[inset_0_0_30px_rgba(16,185,129,0.3)] transition-shadow">
              <ShieldCheck className="text-emerald-400 drop-shadow-[0_0_10px_rgba(16,185,129,0.5)]" size={32} />
            </div>
            <h4 className="text-white font-extrabold text-xl tracking-tight">Prevención Caídas</h4>
            <p className="text-[11px] text-slate-400 font-bold uppercase tracking-[0.2em] mt-2">12 Cuartos Activos</p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 relative z-10 w-full max-w-[250px] mx-auto">
            <div className="bg-[#0a0f1d]/80 p-4 rounded-2xl border border-slate-800/80 shadow-inner">
              <p className="text-[9px] text-slate-500 uppercase font-black tracking-[0.2em] mb-1">Alertas Hoy</p>
              <p className="text-2xl font-black text-white">0</p>
            </div>
            <div className="bg-[#0a0f1d]/80 p-4 rounded-2xl border border-slate-800/80 shadow-inner">
              <p className="text-[9px] text-slate-500 uppercase font-black tracking-[0.2em] mb-1">Precisión</p>
              <p className="text-2xl font-black text-emerald-400 drop-shadow-[0_0_10px_rgba(16,185,129,0.3)]">99%</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="flex-1 relative z-10">
            <h4 className="text-white font-extrabold text-xl tracking-tight">Signos Vitales Ópticos</h4>
            <p className="text-[11px] text-slate-400 font-bold uppercase tracking-[0.2em] mt-2">rPPG Matrix Activa</p>
            
            <div className="mt-8 flex items-baseline gap-3">
              <span className="text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-300 drop-shadow-[0_0_20px_rgba(59,130,246,0.3)]">72</span>
              <span className="text-xs font-black text-slate-500 uppercase tracking-widest">BPM</span>
            </div>
          </div>
      ...
      >
        ...
        <div className="space-y-6 relative z-10 pl-2">
          {[
            { time: '14:20', type: 'Conteo AI', msg: 'Quirófano 02: Análisis YOLO validado.', status: 'ok' },
            { time: '14:15', type: 'UCI Optic', msg: 'UCI 04: Fluctuación rPPG (<2%).', status: 'warn' },
            { time: '14:02', type: 'Pose Est.', msg: 'Hab 302: Paciente sentado en borde.', status: 'info' },
            { time: '13:55', type: 'Conteo AI', msg: 'Quirófano 01: Matriz inicializada.', status: 'ok' },
          ].map((log, i) => (
            <div key={i} className="relative pl-6 before:absolute before:left-0 before:top-2 before:bottom-[-24px] last:before:hidden before:w-[1px] before:bg-slate-800/80 group">
              <div className={`absolute left-[-4px] top-2 w-2 h-2 rounded-full border border-[#0f172a] shadow-sm z-10 ${
                log.status === 'warn' ? 'bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]' : 
              ...
              <div className="flex flex-col gap-1 bg-[#0a0f1d]/40 p-4 rounded-2xl border border-slate-800/50 group-hover:bg-slate-900/60 transition-colors">
                <div className="flex items-center justify-between">
                  <p className={`text-[10px] font-black uppercase tracking-[0.2em] ${
                    log.status === 'warn' ? 'text-amber-400/90' : 
                    log.status === 'info' ? 'text-blue-400/90' : 
                    'text-emerald-400/90'
                  }`}>
                    {log.type}
                  </p>
                  <p className="text-[10px] text-slate-500 font-bold tracking-widest">{log.time}</p>
                </div>
                <p className="text-xs text-slate-300 leading-relaxed font-medium mt-1">{log.msg}</p>
              </div>
            </div>
          ))}
        </div>
